...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    const brandMeta = VARIANT_META[SITE_VARIANT as keyof typeof VARIANT_META] ?? VARIANT_META.full;
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">${brandMeta.headerLogoWord}</span><span class="logo-mobile">${brandMeta.siteName}</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">${brandMeta.siteName.toUpperCase()}</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">${brandMeta.siteName.toUpperCase()}</span>
